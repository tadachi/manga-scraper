...
function readJsonConfigFile(file_path) {
    ...
    if ( typeof(config_json['dry']) !== 'boolean')
        error['dry'] = {'value': config_json['dry'],
            'type':typeof(config_json['dry']),
            'expecting': 'boolean'};
    ...
    if ( typeof(config_json['manga_index_directory']) !== 'string' )
        error['manga_index_directory'] = {'value': config_json['manga_index_directory'],
            'type':typeof(config_json['manga_index_directory']),
            'expecting': 'string'};
